...
export const maximumFilesAllowInImageTools = 30;
export const minimumFilesAllowInImageTools = 3;
...
export const mainNewArrivalsLimit = 10;
export const mainCatPerCollLimit = 10;
...
export const firmsRelatedCategoryLimit = 10;
