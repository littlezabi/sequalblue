...
>
  <div class="dfc-c home-sec">
    ...
    <span>
      Welcome to our website, where you can learn about computers before making
      a purchase. Whether you're looking for a computer or laptop for video
      editing, gaming, office work or home use, we've got you covered. Our team
      provides all the information and specifications you need to make an
      informed decision. From high-performance gaming laptops to versatile
      machines for video editing, we'll help you find the perfect computer for
      your needs. Don't make a purchase before checking our website, get access
      to all the information you need to make an informed decision.
    </span>
    ...
    <a class="p-list-a product-sections dfc-c" href="/" title="abc">
      <section class="product-sec82">
        ...
        <div class="dfc-r a9w6b8q">
          ...
          praesentium laudantium pariatur quam quo itaque omnis error in, natus
          eaque excepturi nisi tenetur quas vitae provident. Lorem ipsum dolor
          sit amet, consectetur adipisicing elit. Qui commodi similique earum
          reprehenderit, praesentium laudantium pariatur quam quo itaque omnis
          error in, natus eaque excepturi nisi tenetur quas vitae provident.
        </div>
